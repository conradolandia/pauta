...
\item
  Copy the \type{doc} and \type{tex} folders to your ConTeXt tree and rebuild your database with \type{context --generate}. You can find more details about the process \goto{on the ConTeXt wiki}[url(https://wiki.contextgarden.net/Modules\#Installation)]. Alternatively, place \type{t-pauta.mkxl} on the same directory.
\item
