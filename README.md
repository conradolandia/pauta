...
4.  The data about the hand[^1] is autogenerated by the module and set
    into the header or footer, following the user configuration.
5.  **Warning:** This module takes over the header and footer typesetting
    ...
    `\setupheadertexts`/`\setupfootertexts`. This will be hopefully
